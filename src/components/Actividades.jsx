            ...
            <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
              ...
              >
                ...
                >
                  <span className="flex">
                    <svg
                      className="flex-shrink-0 mt-2 h-6 w-6 md:w-7 md:h-7 text-green-600  dark:text-gray-200"
                    ...
                    <span className="grow ml-6">
                      <span className="block text-lg font-semibold text-green-600 dark:text-gray-200">
                        Advanced tools
                      </span>
